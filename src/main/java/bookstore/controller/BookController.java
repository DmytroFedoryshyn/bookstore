...
public class BookController {
    ...
    @ApiResponse(responseCode = "200", description = "Book found", content = {
            @Content(mediaType = "application/json", schema = @Schema(implementation = BookDto.class),
                    examples = @ExampleObject(value = "{\"id\": 1, \"title\": \"Sample Book\", \"author\": \"John Doe\"}"))
    })
    ...
    @ApiResponse(responseCode = "200", description = "Book updated", content = {
            @Content(mediaType = "application/json", schema = @Schema(implementation = BookDto.class),
                    examples = @ExampleObject(value = "{\"id\": 1, \"title\": \"Updated Book\", \"author\": \"Jane Smith\"}"))
    })
    @ApiResponse(responseCode = "404", description = "Book not found")
    ...
    @ApiResponse(responseCode = "200", description = "Books found", content = {
            @Content(mediaType = "application/json", schema = @Schema(implementation = BookDto.class),
                    examples = @ExampleObject(value = "[{\"id\": 1, \"title\": \"Book 1\", \"author\": \"Author 1\"}]"))
    })
